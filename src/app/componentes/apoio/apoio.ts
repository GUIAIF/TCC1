...
export class Apoio implements OnInit {
  ...
  ngOnInit() {
    ...
    this.falar('Você escolheu o Apoio Acadêmico. na parte superior da tela você seleciona um destino.');
    ...
    this.falar(`Você selecionou o destino ${nomeDestino}. Clique no botão na parte inferior para iniciar a rota.`);
      } else {
